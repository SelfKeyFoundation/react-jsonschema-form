...
describe("StringField", () => {
  ...
  describe("TextWidget", () => {
    ...
    it("should handle an empty string change event with custom ui:defaultValue", () => {
      ...
      expect(comp.state.formData).toEqual("default");
    });
  ...
  describe("SelectWidget", () => {
    ...
    it("should assign a default value", () => {
      ...
      expect(comp.state.formData).toEqual("bar");
    });
    ...
    it("should reflect the change into the form state", () => {
      ...
      expect(comp.state.formData).toEqual("foo");
    });
    ...
    it("should reflect undefined into form state if empty option selected", () => {
      ...
      expect(comp.state.formData).toBeUndefined();
    });
  ...
  describe("DateTimeWidget", () => {
    ...
    it("should assign a default value", () => {
      ...
      expect(comp.state.formData).toEqual(datetime);
    });
    ...
    it("should reflect the change into the dom", () => {
      ...
      expect(node.querySelector("[type=datetime-local]").value).toEqual(
  ...
  describe("DateWidget", () => {
    ...
    it("should accept a valid entered date", () => {
      ...
      expect(comp.state.errors).toHaveLength(0);
      expect(comp.state.formData).toEqual("2012-12-12");
    });
  ...
  describe("AltDateTimeWidget", () => {
    ...
    it("should reflect the change into the dom", () => {
      ...
      expect(comp.state.formData).toEqual("2012-10-02T01:02:03.000Z");
    });
  ...
  describe("AltDateWidget", () => {
    ...
    it("should reflect the change into the dom", () => {
      ...
      expect(comp.state.formData).toEqual("2012-10-02");
    });
    ...
    describe("Action buttons", () => {
      ...
      it("should set current date when pressing the Now button", () => {
        ...
        expect(comp.state.formData).toEqual(expected);
      });
  ...
  describe("EmailWidget", () => {
    ...
    it("should assign a default value", () => {
      ...
      expect(comp.state.formData).toEqual(email);
    });
  ...
  describe("URLWidget", () => {
    ...
    it("should assign a default value", () => {
      ...
      expect(comp.state.formData).toEqual(url);
    });
  ...
  describe("ColorWidget", () => {
    ...
    it("should assign a default value", () => {
      ...
      expect(comp.state.formData).toEqual(color);
    });
  ...
  describe("FileWidget", () => {
    ...
    it("should assign a default value", () => {
      ...
      expect(comp.state.formData).toEqual(initialValue);
    });
